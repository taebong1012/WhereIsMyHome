...
async function findPw(user, success, fail) {
  await api_headers.post(`/findpw`, user).then(success).catch(fail);
}

export { login, logout, regist, mypage, authUser, tokenRegeneration, deleteUser, modifyUser, kakaoLogin, findPw };
